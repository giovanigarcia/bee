...
/**
 * Wrapper for java.util.regex.Pattern$BmpCharPropertyGreedy (JDK 9+)
 * Handles greedy quantifiers like * and + with character properties
 */
public class BmpCharPropertyGreedy extends Node {

    BmpCharPropertyGreedy(Object node) {
        super(node);
    }
    ...
    String generate() throws Exception {
        ...
        if (matches.isEmpty()) {
            throw new Exception("No matching characters found for BmpCharPropertyGreedy");
        }
